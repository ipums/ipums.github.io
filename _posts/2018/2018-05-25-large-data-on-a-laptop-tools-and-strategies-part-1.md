...
I'd really like to break out mode of transportation by more categories but that will take a long time with the current method. In addition, I'd like to classify workers by income, because I'm suspecting biking to work may be connected to income and class more than profession. So, on to something better. In our next post [in Part 2]({{site.url}}/big-data-on-a-laptop-tools-and-strategies-part-2/), we'll introduce some techniques for dealing with datasets that are bigger than your system's memory or larger than your available storage.
